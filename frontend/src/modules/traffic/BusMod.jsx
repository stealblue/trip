...
const SELECT_START_TERMINAL = createRequestActionTypes('bus/SELECT_START_TERMINAL');
const SELECT_END_TERMINAL = createRequestActionTypes('bus/SELECT_END_TERMINAL');
const SELECT_DATE_BUS = createRequestActionTypes('train/SELECT_DATE_BUS');
const SELECT_PAGE_BUS = createRequestActionTypes('train/SELECT_PAGE_BUS');
...
export const selectDateBus = createAction(SELECT_DATE_BUS, ({ dateBus }) => ({ dateBus }));
export const selectPageBus = createAction(SELECT_PAGE_BUS, (pageNoBus) => (pageNoBus));
