...
const [REPLY_WRITE_POST, REPLY_WRITE_POST_SUCCESS, REPLY_WRITE_POST_FAILURE] =
  createRequestActionTypes("reply/REPLY_WRITE_POST"); //글작성
const [
  REPLY_UPDATE_POST,
  REPLY_UPDATE_POST_SUCCESS,
...
export const replysetOriginPost = createAction(
  REPLY_SET_ORIGIN_POST,
  (reply) => reply
);
export const replyupdatePost = createAction(
  REPLY_UPDATE_POST,
...
const replyupdatePostSaga = createRequestSaga(
  REPLY_UPDATE_POST,
