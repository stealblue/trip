...
const [LIST_AREAS, LIST_AREAS_SUCCESS, LIST_AREAS_FAILURE] = createRequestActionTypes("room/LIST_AREAS");
...
const SHOW_CONTENT_TYPE_ID = createRequestActionTypes('room/SHOW_CONTENT_TYPE_ID');
